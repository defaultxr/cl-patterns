...
- [[file:src/sequence-extensions.lisp][sequence-extensions.lisp]] - additional methods for implementations that support [[http://www.sbcl.org/manual/#Extensible-Sequences][extensible sequences]].
...
You can also use IRC as well if you prefer; the Matrix channel listed above is bridged to ~#cl-patterns~ on irc.freenode.net.
