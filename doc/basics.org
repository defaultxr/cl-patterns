...
If you're familiar with SuperCollider's patterns, you may find it more useful to look at the [[file:SC-differences.md][SC differences]] document instead. This document is meant for people who are not familiar with SuperCollider's patterns system at all, and need a general overview of what it is and how to use it.
